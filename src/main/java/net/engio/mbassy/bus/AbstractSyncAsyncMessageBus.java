...
public abstract class AbstractSyncAsyncMessageBus<T, P extends ISyncAsyncPublicationCommand>
    ...
    protected IMessagePublication addAsynchronousPublication(final IMessagePublication publication) {
        try {
    ...
    // this method queues a message delivery request
    protected IMessagePublication addAsynchronousPublication(final IMessagePublication publication, final long timeout, final TimeUnit unit) {
        try {
